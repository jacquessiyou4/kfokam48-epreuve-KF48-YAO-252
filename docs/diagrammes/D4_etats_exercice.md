...
stateDiagram-v2
    ...
    state "EN_ATTENTE_RELECTEUR<br/>aucun relecteur disponible<br/>—<br/>T6 : lien remplacé / reste dans l'état" as EAR
    state "EN_ATTENTE_RELECTURE<br/>relecteur assigné<br/>—<br/>T6 : lien remplacé / reste dans l'état" as EARL
    state "RELU<br/>note et commentaire rendus<br/>(définitif)" as RELU
...
| T6 | transition interne (reste dans l'état) | `PUT /api/exercices/{id}` | Remplacement du lien si session non clôturée ; le statut ne change pas | EF14 · RG14 |
